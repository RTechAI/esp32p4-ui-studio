...
static lv_obj_t * fg_battery_left_battery = NULL; static lv_obj_t * fg_battery_left_battery_percentage_label = NULL; static lv_obj_t * fg_battery_left_battery_status_label = NULL; static lv_obj_t * fg_battery_left_battery_icon_fill = NULL; static lv_obj_t * fg_battery_left_battery_voltage_label = NULL; static lv_obj_t * fg_battery_left_battery_current_label = NULL; static lv_obj_t * fg_battery_left_battery_runtime_label = NULL; static lv_obj_t * fg_battery_left_battery_temperature_label = NULL; static lv_obj_t * fg_battery_left_battery_health_label = NULL; static lv_obj_t * fg_battery_left_battery_bar = NULL;
static float fg_battery_left_battery_percentage = 76.0f; static float fg_battery_left_battery_voltage = 12.6f; static float fg_battery_left_battery_current = -1.4f; static bool fg_battery_left_battery_charging = false; static int32_t fg_battery_left_battery_runtime = 185; static float fg_battery_left_battery_temperature = 31.5f; static int32_t fg_battery_left_battery_health = 0;
static void fg_battery_left_battery_refresh(void) { uint32_t colour = fg_battery_left_battery_charging ? 0x38BDF8 : (fg_battery_left_battery_percentage <= 10.0f ? 0xE5484D : (fg_battery_left_battery_percentage <= 20.0f ? 0xF2A900 : 0x22C55E)); static const char * names[] = {"GOOD","FAIR","POOR","REPLACE"}; if (fg_battery_left_battery_percentage_label) { lv_label_set_text_fmt(fg_battery_left_battery_percentage_label, "%.1f %%", (double)fg_battery_left_battery_percentage); lv_obj_set_style_text_color(fg_battery_left_battery_percentage_label, lv_color_hex(colour), 0); } if (fg_battery_left_battery_status_label) { lv_label_set_text(fg_battery_left_battery_status_label, fg_battery_left_battery_charging ? "CHARGING" : names[fg_battery_left_battery_health]); lv_obj_set_style_text_color(fg_battery_left_battery_status_label, lv_color_hex(colour), 0); } if (fg_battery_left_battery_icon_fill) { int32_t fill_w = (int32_t)(18.0f * fg_battery_left_battery_percentage / 100.0f); if (fill_w < 0) fill_w = 0; if (fill_w > 18) fill_w = 18; lv_obj_set_width(fg_battery_left_battery_icon_fill, fill_w); lv_obj_set_style_bg_color(fg_battery_left_battery_icon_fill, lv_color_hex(colour), 0); } if (fg_battery_left_battery_bar) { lv_bar_set_value(fg_battery_left_battery_bar, (int32_t)fg_battery_left_battery_percentage, LV_ANIM_OFF); lv_obj_set_style_bg_color(fg_battery_left_battery_bar, lv_color_hex(colour), LV_PART_INDICATOR); } if (fg_battery_left_battery_voltage_label) lv_label_set_text_fmt(fg_battery_left_battery_voltage_label, "VOLTAGE\n%.2f V", (double)fg_battery_left_battery_voltage); if (fg_battery_left_battery_current_label) lv_label_set_text_fmt(fg_battery_left_battery_current_label, "CURRENT\n%.2f A", (double)fg_battery_left_battery_current); if (fg_battery_left_battery_runtime_label) lv_label_set_text_fmt(fg_battery_left_battery_runtime_label, "RUNTIME\n%ldh %ldm", (long)(fg_battery_left_battery_runtime/60), (long)(fg_battery_left_battery_runtime%60)); if (fg_battery_left_battery_temperature_label) lv_label_set_text_fmt(fg_battery_left_battery_temperature_label, "TEMP\n%.1f C", (double)fg_battery_left_battery_temperature); if (fg_battery_left_battery_health_label) lv_label_set_text_fmt(fg_battery_left_battery_health_label, "HEALTH\n%s", names[fg_battery_left_battery_health]); }
void FG_Set_Battery_Left_Percentage(float value) { fg_battery_left_battery_percentage = value < 0.0f ? 0.0f : (value > 100.0f ? 100.0f : value); fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Voltage(float value) { fg_battery_left_battery_voltage = value; fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Current(float value) { fg_battery_left_battery_current = value; fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Charging(bool enabled) { fg_battery_left_battery_charging = enabled; fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Health(int32_t value) { fg_battery_left_battery_health = value < 0 ? 0 : (value > 3 ? 3 : value); fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Runtime(int32_t value) { fg_battery_left_battery_runtime = value < 0 ? 0 : value; fg_battery_left_battery_refresh(); }
void FG_Set_Battery_Left_Temperature(float value) { fg_battery_left_battery_temperature = value; fg_battery_left_battery_refresh(); }
static lv_obj_t * fg_battery_right_battery = NULL; static lv_obj_t * fg_battery_right_battery_percentage_label = NULL; static lv_obj_t * fg_battery_right_battery_status_label = NULL; static lv_obj_t * fg_battery_right_battery_icon_fill = NULL; static lv_obj_t * fg_battery_right_battery_voltage_label = NULL; static lv_obj_t * fg_battery_right_battery_current_label = NULL; static lv_obj_t * fg_battery_right_battery_runtime_label = NULL; static lv_obj_t * fg_battery_right_battery_temperature_label = NULL; static lv_obj_t * fg_battery_right_battery_health_label = NULL; static lv_obj_t * fg_battery_right_battery_bar = NULL;
static float fg_battery_right_battery_percentage = 18.0f; static float fg_battery_right_battery_voltage = 24.3f; static float fg_battery_right_battery_current = 2.1f; static bool fg_battery_right_battery_charging = true; static int32_t fg_battery_right_battery_runtime = 185; static float fg_battery_right_battery_temperature = 31.5f; static int32_t fg_battery_right_battery_health = 1;
static void fg_battery_right_battery_refresh(void) { uint32_t colour = fg_battery_right_battery_charging ? 0x38BDF8 : (fg_battery_right_battery_percentage <= 10.0f ? 0xE5484D : (fg_battery_right_battery_percentage <= 20.0f ? 0xF2A900 : 0x22C55E)); static const char * names[] = {"GOOD","FAIR","POOR","REPLACE"}; if (fg_battery_right_battery_percentage_label) { lv_label_set_text_fmt(fg_battery_right_battery_percentage_label, "%.1f %%", (double)fg_battery_right_battery_percentage); lv_obj_set_style_text_color(fg_battery_right_battery_percentage_label, lv_color_hex(colour), 0); } if (fg_battery_right_battery_status_label) { lv_label_set_text(fg_battery_right_battery_status_label, fg_battery_right_battery_charging ? "CHARGING" : names[fg_battery_right_battery_health]); lv_obj_set_style_text_color(fg_battery_right_battery_status_label, lv_color_hex(colour), 0); } if (fg_battery_right_battery_icon_fill) { int32_t fill_w = (int32_t)(18.0f * fg_battery_right_battery_percentage / 100.0f); if (fill_w < 0) fill_w = 0; if (fill_w > 18) fill_w = 18; lv_obj_set_width(fg_battery_right_battery_icon_fill, fill_w); lv_obj_set_style_bg_color(fg_battery_right_battery_icon_fill, lv_color_hex(colour), 0); } if (fg_battery_right_battery_bar) { lv_bar_set_value(fg_battery_right_battery_bar, (int32_t)fg_battery_right_battery_percentage, LV_ANIM_OFF); lv_obj_set_style_bg_color(fg_battery_right_battery_bar, lv_color_hex(colour), LV_PART_INDICATOR); } if (fg_battery_right_battery_voltage_label) lv_label_set_text_fmt(fg_battery_right_battery_voltage_label, "VOLTAGE\n%.2f V", (double)fg_battery_right_battery_voltage); if (fg_battery_right_battery_current_label) lv_label_set_text_fmt(fg_battery_right_battery_current_label, "CURRENT\n%.2f A", (double)fg_battery_right_battery_current); if (fg_battery_right_battery_runtime_label) lv_label_set_text_fmt(fg_battery_right_battery_runtime_label, "RUNTIME\n%ldh %ldm", (long)(fg_battery_right_battery_runtime/60), (long)(fg_battery_right_battery_runtime%60)); if (fg_battery_right_battery_temperature_label) lv_label_set_text_fmt(fg_battery_right_battery_temperature_label, "TEMP\n%.1f C", (double)fg_battery_right_battery_temperature); if (fg_battery_right_battery_health_label) lv_label_set_text_fmt(fg_battery_right_battery_health_label, "HEALTH\n%s", names[fg_battery_right_battery_health]); }
void FG_Set_Battery_Right_Percentage(float value) { fg_battery_right_battery_percentage = value < 0.0f ? 0.0f : (value > 100.0f ? 100.0f : value); fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Voltage(float value) { fg_battery_right_battery_voltage = value; fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Current(float value) { fg_battery_right_battery_current = value; fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Charging(bool enabled) { fg_battery_right_battery_charging = enabled; fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Health(int32_t value) { fg_battery_right_battery_health = value < 0 ? 0 : (value > 3 ? 3 : value); fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Runtime(int32_t value) { fg_battery_right_battery_runtime = value < 0 ? 0 : value; fg_battery_right_battery_refresh(); }
void FG_Set_Battery_Right_Temperature(float value) { fg_battery_right_battery_temperature = value; fg_battery_right_battery_refresh(); }
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    fg_battery_left_battery = lv_obj_create(fg_application_page); lv_obj_set_pos(fg_battery_left_battery, 20, 40); lv_obj_set_size(fg_battery_left_battery, 460, 250); lv_obj_set_style_bg_color(fg_battery_left_battery, lv_color_hex(0x1E2328), 0); lv_obj_set_style_border_color(fg_battery_left_battery, lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_battery_left_battery, 1, 0); lv_obj_set_style_radius(fg_battery_left_battery, 10, 0); lv_obj_set_style_pad_all(fg_battery_left_battery, 0, 0); lv_obj_clear_flag(fg_battery_left_battery, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj1_title = lv_label_create(fg_battery_left_battery); lv_label_set_text(obj1_title, "Main Battery"); lv_obj_set_pos(obj1_title, 12, 12); lv_obj_set_width(obj1_title, 316); lv_label_set_long_mode(obj1_title, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(obj1_title, lv_color_hex(0xF5F5F5), 0); lv_obj_set_style_text_font(obj1_title, &lv_font_montserrat_14, 0);
    lv_obj_t * obj1_battery_icon = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(obj1_battery_icon, 356, 13); lv_obj_set_size(obj1_battery_icon, 24, 12); lv_obj_set_style_bg_opa(obj1_battery_icon, LV_OPA_TRANSP, 0); lv_obj_set_style_border_color(obj1_battery_icon, lv_color_hex(0xB5B6B8), 0); lv_obj_set_style_border_width(obj1_battery_icon, 1, 0); lv_obj_set_style_radius(obj1_battery_icon, 3, 0); lv_obj_set_style_pad_all(obj1_battery_icon, 0, 0); lv_obj_clear_flag(obj1_battery_icon, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_icon_fill = lv_obj_create(obj1_battery_icon); lv_obj_set_pos(fg_battery_left_battery_icon_fill, 2, 2); lv_obj_set_size(fg_battery_left_battery_icon_fill, 18, 6); lv_obj_set_style_border_width(fg_battery_left_battery_icon_fill, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_icon_fill, 2, 0); lv_obj_clear_flag(fg_battery_left_battery_icon_fill, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj1_battery_cap = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(obj1_battery_cap, 382, 16); lv_obj_set_size(obj1_battery_cap, 3, 6); lv_obj_set_style_bg_color(obj1_battery_cap, lv_color_hex(0xB5B6B8), 0); lv_obj_set_style_border_width(obj1_battery_cap, 0, 0); lv_obj_set_style_radius(obj1_battery_cap, 2, 0); lv_obj_clear_flag(obj1_battery_cap, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_status_label = lv_label_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_status_label, 390, 13); lv_obj_set_width(fg_battery_left_battery_status_label, 58); lv_label_set_long_mode(fg_battery_left_battery_status_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_align(fg_battery_left_battery_status_label, LV_TEXT_ALIGN_RIGHT, 0); lv_obj_set_style_text_font(fg_battery_left_battery_status_label, &lv_font_montserrat_10, 0);
    fg_battery_left_battery_percentage_label = lv_label_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_percentage_label, 12, 40); lv_obj_set_style_text_font(fg_battery_left_battery_percentage_label, &lv_font_montserrat_32, 0);
    fg_battery_left_battery_bar = lv_bar_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_bar, 12, 82); lv_obj_set_size(fg_battery_left_battery_bar, 436, 9); lv_bar_set_range(fg_battery_left_battery_bar, 0, 100); lv_obj_set_style_bg_color(fg_battery_left_battery_bar, lv_color_hex(0x2A3138), LV_PART_MAIN); lv_obj_set_style_radius(fg_battery_left_battery_bar, 4, LV_PART_MAIN); lv_obj_set_style_radius(fg_battery_left_battery_bar, 4, LV_PART_INDICATOR);
    lv_obj_t * fg_battery_left_battery_voltage_label_tile = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_voltage_label_tile, 12, 104); lv_obj_set_size(fg_battery_left_battery_voltage_label_tile, 140, 31); lv_obj_set_style_bg_color(fg_battery_left_battery_voltage_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_left_battery_voltage_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_voltage_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_left_battery_voltage_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_left_battery_voltage_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_voltage_label = lv_label_create(fg_battery_left_battery_voltage_label_tile); lv_obj_set_pos(fg_battery_left_battery_voltage_label, 6, 4); lv_obj_set_width(fg_battery_left_battery_voltage_label, 128); lv_label_set_long_mode(fg_battery_left_battery_voltage_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_left_battery_voltage_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_left_battery_voltage_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_left_battery_current_label_tile = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_current_label_tile, 160, 104); lv_obj_set_size(fg_battery_left_battery_current_label_tile, 140, 31); lv_obj_set_style_bg_color(fg_battery_left_battery_current_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_left_battery_current_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_current_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_left_battery_current_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_left_battery_current_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_current_label = lv_label_create(fg_battery_left_battery_current_label_tile); lv_obj_set_pos(fg_battery_left_battery_current_label, 6, 4); lv_obj_set_width(fg_battery_left_battery_current_label, 128); lv_label_set_long_mode(fg_battery_left_battery_current_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_left_battery_current_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_left_battery_current_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_left_battery_runtime_label_tile = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_runtime_label_tile, 308, 104); lv_obj_set_size(fg_battery_left_battery_runtime_label_tile, 140, 31); lv_obj_set_style_bg_color(fg_battery_left_battery_runtime_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_left_battery_runtime_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_runtime_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_left_battery_runtime_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_left_battery_runtime_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_runtime_label = lv_label_create(fg_battery_left_battery_runtime_label_tile); lv_obj_set_pos(fg_battery_left_battery_runtime_label, 6, 4); lv_obj_set_width(fg_battery_left_battery_runtime_label, 128); lv_label_set_long_mode(fg_battery_left_battery_runtime_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_left_battery_runtime_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_left_battery_runtime_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_left_battery_temperature_label_tile = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_temperature_label_tile, 12, 143); lv_obj_set_size(fg_battery_left_battery_temperature_label_tile, 140, 31); lv_obj_set_style_bg_color(fg_battery_left_battery_temperature_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_left_battery_temperature_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_temperature_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_left_battery_temperature_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_left_battery_temperature_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_temperature_label = lv_label_create(fg_battery_left_battery_temperature_label_tile); lv_obj_set_pos(fg_battery_left_battery_temperature_label, 6, 4); lv_obj_set_width(fg_battery_left_battery_temperature_label, 128); lv_label_set_long_mode(fg_battery_left_battery_temperature_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_left_battery_temperature_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_left_battery_temperature_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_left_battery_health_label_tile = lv_obj_create(fg_battery_left_battery); lv_obj_set_pos(fg_battery_left_battery_health_label_tile, 160, 143); lv_obj_set_size(fg_battery_left_battery_health_label_tile, 140, 31); lv_obj_set_style_bg_color(fg_battery_left_battery_health_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_left_battery_health_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_left_battery_health_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_left_battery_health_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_left_battery_health_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_left_battery_health_label = lv_label_create(fg_battery_left_battery_health_label_tile); lv_obj_set_pos(fg_battery_left_battery_health_label, 6, 4); lv_obj_set_width(fg_battery_left_battery_health_label, 128); lv_label_set_long_mode(fg_battery_left_battery_health_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_left_battery_health_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_left_battery_health_label, lv_color_hex(0xF5F5F5), 0);
    fg_battery_left_battery_refresh();

    fg_battery_right_battery = lv_obj_create(fg_application_page); lv_obj_set_pos(fg_battery_right_battery, 520, 40); lv_obj_set_size(fg_battery_right_battery, 460, 250); lv_obj_set_style_bg_color(fg_battery_right_battery, lv_color_hex(0x1E2328), 0); lv_obj_set_style_border_color(fg_battery_right_battery, lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_battery_right_battery, 1, 0); lv_obj_set_style_radius(fg_battery_right_battery, 10, 0); lv_obj_set_style_pad_all(fg_battery_right_battery, 0, 0); lv_obj_clear_flag(fg_battery_right_battery, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj2_title = lv_label_create(fg_battery_right_battery); lv_label_set_text(obj2_title, "Backup UPS"); lv_obj_set_pos(obj2_title, 8, 8); lv_obj_set_width(obj2_title, 340); lv_label_set_long_mode(obj2_title, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(obj2_title, lv_color_hex(0xF5F5F5), 0); lv_obj_set_style_text_font(obj2_title, &lv_font_montserrat_12, 0);
    lv_obj_t * obj2_battery_icon = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(obj2_battery_icon, 360, 9); lv_obj_set_size(obj2_battery_icon, 24, 12); lv_obj_set_style_bg_opa(obj2_battery_icon, LV_OPA_TRANSP, 0); lv_obj_set_style_border_color(obj2_battery_icon, lv_color_hex(0xB5B6B8), 0); lv_obj_set_style_border_width(obj2_battery_icon, 1, 0); lv_obj_set_style_radius(obj2_battery_icon, 3, 0); lv_obj_set_style_pad_all(obj2_battery_icon, 0, 0); lv_obj_clear_flag(obj2_battery_icon, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_icon_fill = lv_obj_create(obj2_battery_icon); lv_obj_set_pos(fg_battery_right_battery_icon_fill, 2, 2); lv_obj_set_size(fg_battery_right_battery_icon_fill, 18, 6); lv_obj_set_style_border_width(fg_battery_right_battery_icon_fill, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_icon_fill, 2, 0); lv_obj_clear_flag(fg_battery_right_battery_icon_fill, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj2_battery_cap = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(obj2_battery_cap, 386, 12); lv_obj_set_size(obj2_battery_cap, 3, 6); lv_obj_set_style_bg_color(obj2_battery_cap, lv_color_hex(0xB5B6B8), 0); lv_obj_set_style_border_width(obj2_battery_cap, 0, 0); lv_obj_set_style_radius(obj2_battery_cap, 2, 0); lv_obj_clear_flag(obj2_battery_cap, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_status_label = lv_label_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_status_label, 394, 9); lv_obj_set_width(fg_battery_right_battery_status_label, 58); lv_label_set_long_mode(fg_battery_right_battery_status_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_align(fg_battery_right_battery_status_label, LV_TEXT_ALIGN_RIGHT, 0); lv_obj_set_style_text_font(fg_battery_right_battery_status_label, &lv_font_montserrat_10, 0);
    fg_battery_right_battery_percentage_label = lv_label_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_percentage_label, 8, 32); lv_obj_set_style_text_font(fg_battery_right_battery_percentage_label, &lv_font_montserrat_28, 0);
    fg_battery_right_battery_bar = lv_bar_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_bar, 8, 68); lv_obj_set_size(fg_battery_right_battery_bar, 444, 8); lv_bar_set_range(fg_battery_right_battery_bar, 0, 100); lv_obj_set_style_bg_color(fg_battery_right_battery_bar, lv_color_hex(0x2A3138), LV_PART_MAIN); lv_obj_set_style_radius(fg_battery_right_battery_bar, 4, LV_PART_MAIN); lv_obj_set_style_radius(fg_battery_right_battery_bar, 4, LV_PART_INDICATOR);
    lv_obj_t * fg_battery_right_battery_voltage_label_tile = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_voltage_label_tile, 8, 86); lv_obj_set_size(fg_battery_right_battery_voltage_label_tile, 144, 29); lv_obj_set_style_bg_color(fg_battery_right_battery_voltage_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_right_battery_voltage_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_voltage_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_right_battery_voltage_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_right_battery_voltage_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_voltage_label = lv_label_create(fg_battery_right_battery_voltage_label_tile); lv_obj_set_pos(fg_battery_right_battery_voltage_label, 6, 4); lv_obj_set_width(fg_battery_right_battery_voltage_label, 132); lv_label_set_long_mode(fg_battery_right_battery_voltage_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_right_battery_voltage_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_right_battery_voltage_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_right_battery_current_label_tile = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_current_label_tile, 157, 86); lv_obj_set_size(fg_battery_right_battery_current_label_tile, 144, 29); lv_obj_set_style_bg_color(fg_battery_right_battery_current_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_right_battery_current_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_current_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_right_battery_current_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_right_battery_current_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_current_label = lv_label_create(fg_battery_right_battery_current_label_tile); lv_obj_set_pos(fg_battery_right_battery_current_label, 6, 4); lv_obj_set_width(fg_battery_right_battery_current_label, 132); lv_label_set_long_mode(fg_battery_right_battery_current_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_right_battery_current_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_right_battery_current_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_right_battery_runtime_label_tile = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_runtime_label_tile, 306, 86); lv_obj_set_size(fg_battery_right_battery_runtime_label_tile, 144, 29); lv_obj_set_style_bg_color(fg_battery_right_battery_runtime_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_right_battery_runtime_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_runtime_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_right_battery_runtime_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_right_battery_runtime_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_runtime_label = lv_label_create(fg_battery_right_battery_runtime_label_tile); lv_obj_set_pos(fg_battery_right_battery_runtime_label, 6, 4); lv_obj_set_width(fg_battery_right_battery_runtime_label, 132); lv_label_set_long_mode(fg_battery_right_battery_runtime_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_right_battery_runtime_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_right_battery_runtime_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_right_battery_temperature_label_tile = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_temperature_label_tile, 8, 120); lv_obj_set_size(fg_battery_right_battery_temperature_label_tile, 144, 29); lv_obj_set_style_bg_color(fg_battery_right_battery_temperature_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_right_battery_temperature_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_temperature_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_right_battery_temperature_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_right_battery_temperature_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_temperature_label = lv_label_create(fg_battery_right_battery_temperature_label_tile); lv_obj_set_pos(fg_battery_right_battery_temperature_label, 6, 4); lv_obj_set_width(fg_battery_right_battery_temperature_label, 132); lv_label_set_long_mode(fg_battery_right_battery_temperature_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_right_battery_temperature_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_right_battery_temperature_label, lv_color_hex(0xF5F5F5), 0);
    lv_obj_t * fg_battery_right_battery_health_label_tile = lv_obj_create(fg_battery_right_battery); lv_obj_set_pos(fg_battery_right_battery_health_label_tile, 157, 120); lv_obj_set_size(fg_battery_right_battery_health_label_tile, 144, 29); lv_obj_set_style_bg_color(fg_battery_right_battery_health_label_tile, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_width(fg_battery_right_battery_health_label_tile, 0, 0); lv_obj_set_style_radius(fg_battery_right_battery_health_label_tile, 5, 0); lv_obj_set_style_pad_all(fg_battery_right_battery_health_label_tile, 0, 0); lv_obj_clear_flag(fg_battery_right_battery_health_label_tile, LV_OBJ_FLAG_SCROLLABLE);
    fg_battery_right_battery_health_label = lv_label_create(fg_battery_right_battery_health_label_tile); lv_obj_set_pos(fg_battery_right_battery_health_label, 6, 4); lv_obj_set_width(fg_battery_right_battery_health_label, 132); lv_label_set_long_mode(fg_battery_right_battery_health_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_battery_right_battery_health_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_battery_right_battery_health_label, lv_color_hex(0xF5F5F5), 0);
    fg_battery_right_battery_refresh();


    FG_Set_Battery_Left_Percentage(64.0f); FG_Set_Battery_Left_Voltage(12.42f); FG_Set_Battery_Left_Current(-2.25f); FG_Set_Battery_Left_Charging(false); FG_Set_Battery_Left_Health(0); FG_Set_Battery_Left_Runtime(142); FG_Set_Battery_Left_Temperature(33.8f); FG_Set_Battery_Right_Percentage(27.0f); FG_Set_Battery_Right_Voltage(25.10f); FG_Set_Battery_Right_Current(3.40f); FG_Set_Battery_Right_Charging(true); FG_Set_Battery_Right_Health(1); FG_Set_Battery_Right_Runtime(88); FG_Set_Battery_Right_Temperature(29.6f); fg_ram_probe_log("02 after Battery Card SDK proof updates");
