...
static lv_obj_t * fg_tank_left_tank = NULL; static lv_obj_t * fg_tank_left_tank_vessel = NULL; static lv_obj_t * fg_tank_left_tank_fill = NULL; static lv_obj_t * fg_tank_left_tank_percentage_label = NULL; static lv_obj_t * fg_tank_left_tank_volume_label = NULL; static lv_obj_t * fg_tank_left_tank_status_label = NULL; static lv_obj_t * fg_tank_left_tank_low_label = NULL; static lv_obj_t * fg_tank_left_tank_high_label = NULL; static lv_obj_t * fg_tank_left_tank_critical_label = NULL;
static float fg_tank_left_tank_level = 68.0f; static float fg_tank_left_tank_volume = 680.0f; static float fg_tank_left_tank_capacity = 1000.0f; static char fg_tank_left_tank_units[13] = "L"; static float fg_tank_left_tank_low = 20.0f; static float fg_tank_left_tank_high = 90.0f;
static void fg_tank_left_tank_refresh(void) { bool overflow = fg_tank_left_tank_level > 100.0f || (fg_tank_left_tank_capacity > 0.0f && fg_tank_left_tank_volume > fg_tank_left_tank_capacity); bool empty = fg_tank_left_tank_level <= 5.0f; uint32_t colour = overflow ? 0xEF4444 : (empty ? 0xE5484D : (fg_tank_left_tank_level <= fg_tank_left_tank_low ? 0xF2A900 : (fg_tank_left_tank_level >= fg_tank_left_tank_high ? 0xA78BFA : 0x38BDF8))); const char * status = overflow ? "OVERFLOW" : (empty ? "EMPTY" : (fg_tank_left_tank_level <= fg_tank_left_tank_low ? "LOW" : (fg_tank_left_tank_level >= fg_tank_left_tank_high ? "HIGH" : "NORMAL"))); float bounded = fg_tank_left_tank_level < 0.0f ? 0.0f : (fg_tank_left_tank_level > 100.0f ? 100.0f : fg_tank_left_tank_level); if (fg_tank_left_tank_percentage_label) { lv_label_set_text_fmt(fg_tank_left_tank_percentage_label, "%.1f%%", (double)fg_tank_left_tank_level); lv_obj_set_style_text_color(fg_tank_left_tank_percentage_label, lv_color_hex(colour), 0); } if (fg_tank_left_tank_volume_label) lv_label_set_text_fmt(fg_tank_left_tank_volume_label, "%.1f / %.1f %s", (double)fg_tank_left_tank_volume, (double)fg_tank_left_tank_capacity, fg_tank_left_tank_units); if (fg_tank_left_tank_status_label) { lv_label_set_text(fg_tank_left_tank_status_label, status); lv_obj_set_style_text_color(fg_tank_left_tank_status_label, lv_color_hex(colour), 0); } if (fg_tank_left_tank_fill) { lv_bar_set_value(fg_tank_left_tank_fill, (int32_t)bounded, LV_ANIM_ON); lv_obj_set_style_bg_color(fg_tank_left_tank_fill, lv_color_hex(colour), LV_PART_INDICATOR); } if (fg_tank_left_tank_low_label) lv_label_set_text_fmt(fg_tank_left_tank_low_label, "LOW\n%.0f%%", (double)fg_tank_left_tank_low); if (fg_tank_left_tank_high_label) lv_label_set_text_fmt(fg_tank_left_tank_high_label, "HIGH\n%.0f%%", (double)fg_tank_left_tank_high); if (fg_tank_left_tank_critical_label) lv_label_set_text(fg_tank_left_tank_critical_label, "CRITICAL\n5%"); }
void FG_Set_Tank_Left_Level(float percent) { fg_tank_left_tank_level = percent < 0.0f ? 0.0f : (percent > 120.0f ? 120.0f : percent); fg_tank_left_tank_refresh(); }
void FG_Set_Tank_Left_Volume(float value) { fg_tank_left_tank_volume = value < 0.0f ? 0.0f : value; fg_tank_left_tank_refresh(); }
void FG_Set_Tank_Left_Capacity(float value) { fg_tank_left_tank_capacity = value < 0.0f ? 0.0f : value; fg_tank_left_tank_refresh(); }
void FG_Set_Tank_Left_Units(const char * units) { if (!units) units = ""; snprintf(fg_tank_left_tank_units, sizeof(fg_tank_left_tank_units), "%s", units); fg_tank_left_tank_refresh(); }
void FG_Set_Tank_Left_LowLevel(float value) { fg_tank_left_tank_low = value < 0.0f ? 0.0f : (value > 100.0f ? 100.0f : value); if (fg_tank_left_tank_high < fg_tank_left_tank_low) fg_tank_left_tank_high = fg_tank_left_tank_low; fg_tank_left_tank_refresh(); }
void FG_Set_Tank_Left_HighLevel(float value) { fg_tank_left_tank_high = value < fg_tank_left_tank_low ? fg_tank_left_tank_low : (value > 100.0f ? 100.0f : value); fg_tank_left_tank_refresh(); }
static lv_obj_t * fg_tank_right_tank = NULL; static lv_obj_t * fg_tank_right_tank_vessel = NULL; static lv_obj_t * fg_tank_right_tank_fill = NULL; static lv_obj_t * fg_tank_right_tank_percentage_label = NULL; static lv_obj_t * fg_tank_right_tank_volume_label = NULL; static lv_obj_t * fg_tank_right_tank_status_label = NULL; static lv_obj_t * fg_tank_right_tank_low_label = NULL; static lv_obj_t * fg_tank_right_tank_high_label = NULL; static lv_obj_t * fg_tank_right_tank_critical_label = NULL;
static float fg_tank_right_tank_level = 18.0f; static float fg_tank_right_tank_volume = 216.0f; static float fg_tank_right_tank_capacity = 1200.0f; static char fg_tank_right_tank_units[13] = "L"; static float fg_tank_right_tank_low = 20.0f; static float fg_tank_right_tank_high = 90.0f;
static void fg_tank_right_tank_refresh(void) { bool overflow = fg_tank_right_tank_level > 100.0f || (fg_tank_right_tank_capacity > 0.0f && fg_tank_right_tank_volume > fg_tank_right_tank_capacity); bool empty = fg_tank_right_tank_level <= 5.0f; uint32_t colour = overflow ? 0xEF4444 : (empty ? 0xE5484D : (fg_tank_right_tank_level <= fg_tank_right_tank_low ? 0xF2A900 : (fg_tank_right_tank_level >= fg_tank_right_tank_high ? 0xA78BFA : 0x38BDF8))); const char * status = overflow ? "OVERFLOW" : (empty ? "EMPTY" : (fg_tank_right_tank_level <= fg_tank_right_tank_low ? "LOW" : (fg_tank_right_tank_level >= fg_tank_right_tank_high ? "HIGH" : "NORMAL"))); float bounded = fg_tank_right_tank_level < 0.0f ? 0.0f : (fg_tank_right_tank_level > 100.0f ? 100.0f : fg_tank_right_tank_level); if (fg_tank_right_tank_percentage_label) { lv_label_set_text_fmt(fg_tank_right_tank_percentage_label, "%.1f%%", (double)fg_tank_right_tank_level); lv_obj_set_style_text_color(fg_tank_right_tank_percentage_label, lv_color_hex(colour), 0); } if (fg_tank_right_tank_volume_label) lv_label_set_text_fmt(fg_tank_right_tank_volume_label, "%.1f / %.1f %s", (double)fg_tank_right_tank_volume, (double)fg_tank_right_tank_capacity, fg_tank_right_tank_units); if (fg_tank_right_tank_status_label) { lv_label_set_text(fg_tank_right_tank_status_label, status); lv_obj_set_style_text_color(fg_tank_right_tank_status_label, lv_color_hex(colour), 0); } if (fg_tank_right_tank_fill) { lv_bar_set_value(fg_tank_right_tank_fill, (int32_t)bounded, LV_ANIM_ON); lv_obj_set_style_bg_color(fg_tank_right_tank_fill, lv_color_hex(colour), LV_PART_INDICATOR); } if (fg_tank_right_tank_low_label) lv_label_set_text_fmt(fg_tank_right_tank_low_label, "LOW\n%.0f%%", (double)fg_tank_right_tank_low); if (fg_tank_right_tank_high_label) lv_label_set_text_fmt(fg_tank_right_tank_high_label, "HIGH\n%.0f%%", (double)fg_tank_right_tank_high); if (fg_tank_right_tank_critical_label) lv_label_set_text(fg_tank_right_tank_critical_label, "CRITICAL\n5%"); }
void FG_Set_Tank_Right_Level(float percent) { fg_tank_right_tank_level = percent < 0.0f ? 0.0f : (percent > 120.0f ? 120.0f : percent); fg_tank_right_tank_refresh(); }
void FG_Set_Tank_Right_Volume(float value) { fg_tank_right_tank_volume = value < 0.0f ? 0.0f : value; fg_tank_right_tank_refresh(); }
void FG_Set_Tank_Right_Capacity(float value) { fg_tank_right_tank_capacity = value < 0.0f ? 0.0f : value; fg_tank_right_tank_refresh(); }
void FG_Set_Tank_Right_Units(const char * units) { if (!units) units = ""; snprintf(fg_tank_right_tank_units, sizeof(fg_tank_right_tank_units), "%s", units); fg_tank_right_tank_refresh(); }
void FG_Set_Tank_Right_LowLevel(float value) { fg_tank_right_tank_low = value < 0.0f ? 0.0f : (value > 100.0f ? 100.0f : value); if (fg_tank_right_tank_high < fg_tank_right_tank_low) fg_tank_right_tank_high = fg_tank_right_tank_low; fg_tank_right_tank_refresh(); }
void FG_Set_Tank_Right_HighLevel(float value) { fg_tank_right_tank_high = value < fg_tank_right_tank_low ? fg_tank_right_tank_low : (value > 100.0f ? 100.0f : value); fg_tank_right_tank_refresh(); }
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    fg_tank_left_tank = lv_obj_create(fg_application_page); lv_obj_set_pos(fg_tank_left_tank, 20, 70); lv_obj_set_size(fg_tank_left_tank, 470, 470); lv_obj_set_style_bg_color(fg_tank_left_tank, lv_color_hex(0x1E2328), 0); lv_obj_set_style_border_color(fg_tank_left_tank, lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_tank_left_tank, 1, 0); lv_obj_set_style_radius(fg_tank_left_tank, 10, 0); lv_obj_set_style_pad_all(fg_tank_left_tank, 0, 0); lv_obj_clear_flag(fg_tank_left_tank, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj1_title = lv_label_create(fg_tank_left_tank); lv_label_set_text(obj1_title, "Process Water"); lv_obj_set_pos(obj1_title, 12, 12); lv_obj_set_width(obj1_title, 370); lv_label_set_long_mode(obj1_title, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(obj1_title, lv_color_hex(0xF5F5F5), 0); lv_obj_set_style_text_font(obj1_title, &lv_font_montserrat_14, 0);
    fg_tank_left_tank_status_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_status_label, 386, 13); lv_obj_set_width(fg_tank_left_tank_status_label, 72); lv_obj_set_style_text_align(fg_tank_left_tank_status_label, LV_TEXT_ALIGN_RIGHT, 0); lv_obj_set_style_text_font(fg_tank_left_tank_status_label, &lv_font_montserrat_10, 0);
    fg_tank_left_tank_vessel = lv_obj_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_vessel, 12, 40); lv_obj_set_size(fg_tank_left_tank_vessel, 70, 406); lv_obj_set_style_bg_color(fg_tank_left_tank_vessel, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_tank_left_tank_vessel, lv_color_hex(0x94A3B8), 0); lv_obj_set_style_border_width(fg_tank_left_tank_vessel, 3, 0); lv_obj_set_style_radius(fg_tank_left_tank_vessel, 28, 0); lv_obj_set_style_pad_all(fg_tank_left_tank_vessel, 3, 0); lv_obj_clear_flag(fg_tank_left_tank_vessel, LV_OBJ_FLAG_SCROLLABLE);
    fg_tank_left_tank_fill = lv_bar_create(fg_tank_left_tank_vessel); lv_obj_set_size(fg_tank_left_tank_fill, LV_PCT(100), LV_PCT(100)); lv_obj_center(fg_tank_left_tank_fill); lv_bar_set_range(fg_tank_left_tank_fill, 0, 100); lv_obj_set_style_bg_opa(fg_tank_left_tank_fill, LV_OPA_TRANSP, LV_PART_MAIN); lv_obj_set_style_border_width(fg_tank_left_tank_fill, 0, LV_PART_MAIN); lv_obj_set_style_radius(fg_tank_left_tank_fill, 12, LV_PART_INDICATOR);
    fg_tank_left_tank_percentage_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_percentage_label, 96, 54); lv_obj_set_style_text_font(fg_tank_left_tank_percentage_label, &lv_font_montserrat_32, 0);
    fg_tank_left_tank_volume_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_volume_label, 96, 94); lv_obj_set_width(fg_tank_left_tank_volume_label, 362); lv_label_set_long_mode(fg_tank_left_tank_volume_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(fg_tank_left_tank_volume_label, lv_color_hex(0xF5F5F5), 0);
    fg_tank_left_tank_low_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_low_label, 96, 132); lv_obj_set_width(fg_tank_left_tank_low_label, 117); lv_obj_set_style_text_font(fg_tank_left_tank_low_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_left_tank_low_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_left_tank_low_label, "LOW");
    fg_tank_left_tank_high_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_high_label, 218, 132); lv_obj_set_width(fg_tank_left_tank_high_label, 117); lv_obj_set_style_text_font(fg_tank_left_tank_high_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_left_tank_high_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_left_tank_high_label, "HIGH");
    fg_tank_left_tank_critical_label = lv_label_create(fg_tank_left_tank); lv_obj_set_pos(fg_tank_left_tank_critical_label, 340, 132); lv_obj_set_width(fg_tank_left_tank_critical_label, 117); lv_obj_set_style_text_font(fg_tank_left_tank_critical_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_left_tank_critical_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_left_tank_critical_label, "CRITICAL");
    fg_tank_left_tank_refresh();

    fg_tank_right_tank = lv_obj_create(fg_application_page); lv_obj_set_pos(fg_tank_right_tank, 530, 70); lv_obj_set_size(fg_tank_right_tank, 470, 470); lv_obj_set_style_bg_color(fg_tank_right_tank, lv_color_hex(0x1E2328), 0); lv_obj_set_style_border_color(fg_tank_right_tank, lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_tank_right_tank, 1, 0); lv_obj_set_style_radius(fg_tank_right_tank, 10, 0); lv_obj_set_style_pad_all(fg_tank_right_tank, 0, 0); lv_obj_clear_flag(fg_tank_right_tank, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj2_title = lv_label_create(fg_tank_right_tank); lv_label_set_text(obj2_title, "Fuel Reserve"); lv_obj_set_pos(obj2_title, 8, 8); lv_obj_set_width(obj2_title, 370); lv_label_set_long_mode(obj2_title, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(obj2_title, lv_color_hex(0xF5F5F5), 0); lv_obj_set_style_text_font(obj2_title, &lv_font_montserrat_12, 0);
    fg_tank_right_tank_status_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_status_label, 386, 9); lv_obj_set_width(fg_tank_right_tank_status_label, 72); lv_obj_set_style_text_align(fg_tank_right_tank_status_label, LV_TEXT_ALIGN_RIGHT, 0); lv_obj_set_style_text_font(fg_tank_right_tank_status_label, &lv_font_montserrat_10, 0);
    fg_tank_right_tank_vessel = lv_obj_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_vessel, 8, 35); lv_obj_set_size(fg_tank_right_tank_vessel, 54, 412); lv_obj_set_style_bg_color(fg_tank_right_tank_vessel, lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_tank_right_tank_vessel, lv_color_hex(0x94A3B8), 0); lv_obj_set_style_border_width(fg_tank_right_tank_vessel, 3, 0); lv_obj_set_style_radius(fg_tank_right_tank_vessel, 18, 0); lv_obj_set_style_pad_all(fg_tank_right_tank_vessel, 3, 0); lv_obj_clear_flag(fg_tank_right_tank_vessel, LV_OBJ_FLAG_SCROLLABLE);
    fg_tank_right_tank_fill = lv_bar_create(fg_tank_right_tank_vessel); lv_obj_set_size(fg_tank_right_tank_fill, LV_PCT(100), LV_PCT(100)); lv_obj_center(fg_tank_right_tank_fill); lv_bar_set_range(fg_tank_right_tank_fill, 0, 100); lv_obj_set_style_bg_opa(fg_tank_right_tank_fill, LV_OPA_TRANSP, LV_PART_MAIN); lv_obj_set_style_border_width(fg_tank_right_tank_fill, 0, LV_PART_MAIN); lv_obj_set_style_radius(fg_tank_right_tank_fill, 12, LV_PART_INDICATOR);
    fg_tank_right_tank_percentage_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_percentage_label, 72, 48); lv_obj_set_style_text_font(fg_tank_right_tank_percentage_label, &lv_font_montserrat_28, 0);
    fg_tank_right_tank_volume_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_volume_label, 72, 82); lv_obj_set_width(fg_tank_right_tank_volume_label, 390); lv_label_set_long_mode(fg_tank_right_tank_volume_label, LV_LABEL_LONG_DOT); lv_obj_set_style_text_color(fg_tank_right_tank_volume_label, lv_color_hex(0xF5F5F5), 0);
    fg_tank_right_tank_low_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_low_label, 72, 116); lv_obj_set_width(fg_tank_right_tank_low_label, 126); lv_obj_set_style_text_font(fg_tank_right_tank_low_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_right_tank_low_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_right_tank_low_label, "LOW");
    fg_tank_right_tank_high_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_high_label, 203, 116); lv_obj_set_width(fg_tank_right_tank_high_label, 126); lv_obj_set_style_text_font(fg_tank_right_tank_high_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_right_tank_high_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_right_tank_high_label, "HIGH");
    fg_tank_right_tank_critical_label = lv_label_create(fg_tank_right_tank); lv_obj_set_pos(fg_tank_right_tank_critical_label, 334, 116); lv_obj_set_width(fg_tank_right_tank_critical_label, 126); lv_obj_set_style_text_font(fg_tank_right_tank_critical_label, &lv_font_montserrat_10, 0); lv_obj_set_style_text_color(fg_tank_right_tank_critical_label, lv_color_hex(0xB5B6B8), 0); lv_label_set_text(fg_tank_right_tank_critical_label, "CRITICAL");
    fg_tank_right_tank_refresh();


    FG_Set_Tank_Left_Level(74.0f); FG_Set_Tank_Left_Volume(740.0f); FG_Set_Tank_Left_Capacity(1000.0f); FG_Set_Tank_Left_Units("L"); FG_Set_Tank_Left_LowLevel(20.0f); FG_Set_Tank_Left_HighLevel(90.0f); FG_Set_Tank_Right_Level(12.0f); FG_Set_Tank_Right_Volume(144.0f); FG_Set_Tank_Right_Capacity(1200.0f); FG_Set_Tank_Right_Units("L"); FG_Set_Tank_Right_LowLevel(18.0f); FG_Set_Tank_Right_HighLevel(92.0f); fg_ram_probe_log("02 after Tank Level Card SDK proof updates");
