...
static void fg_menu_matrix_button_matrix_apply_selection(uint32_t button_index, bool update_widget)
{
    if (fg_menu_matrix_button_matrix == NULL || fg_menu_matrix_button_matrix_button_count == 0) return;
    if (button_index >= fg_menu_matrix_button_matrix_button_count) button_index = fg_menu_matrix_button_matrix_button_count - 1;
    if (lv_buttonmatrix_has_button_ctrl(fg_menu_matrix_button_matrix, button_index, LV_BUTTONMATRIX_CTRL_DISABLED)) return;
    if (button_index == fg_menu_matrix_button_matrix_selected_index) return;
    fg_menu_matrix_button_matrix_selected_index = button_index;
    if (update_widget) {
...
static void fg_menu_matrix_button_matrix_value_changed_cb(lv_event_t * event)
{
    lv_obj_t * matrix = lv_event_get_current_target(event);
    if (matrix != fg_menu_matrix_button_matrix) return;
...
static void fg_keyboard_show_for(lv_obj_t * textarea)
{
    ...
    if (!fg_system_wifi_keyboard) {
        ...
        lv_obj_set_style_bg_color(fg_system_wifi_keyboard, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
        lv_obj_set_style_border_width(fg_system_wifi_keyboard, 1, LV_PART_MAIN);
        lv_obj_set_style_border_color(fg_system_wifi_keyboard, lv_color_hex(0x06B6D4), LV_PART_MAIN);
        ...
        lv_obj_set_style_bg_color(fg_system_wifi_keyboard, lv_color_hex(0xE6F1F7), LV_PART_ITEMS);
        lv_obj_set_style_text_color(fg_system_wifi_keyboard, lv_color_hex(0x0F172A), LV_PART_ITEMS);
        lv_obj_set_style_border_width(fg_system_wifi_keyboard, 1, LV_PART_ITEMS);
        lv_obj_set_style_border_color(fg_system_wifi_keyboard, lv_color_hex(0x94A3B8), LV_PART_ITEMS);
...
static lv_obj_t * fg_system_create_button(lv_obj_t * parent, const char * text, int32_t x, int32_t y, int32_t width, int32_t height)
{
    ...
    lv_obj_set_style_bg_color(button, lv_color_hex(0x06B6D4), LV_STATE_PRESSED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x06B6D4), LV_STATE_PRESSED);
    lv_obj_set_style_bg_color(button, lv_color_hex(0xE6F1F7), LV_STATE_FOCUSED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x06B6D4), LV_STATE_FOCUSED);
    lv_obj_set_style_bg_color(button, lv_color_hex(0xE6F1F7), LV_STATE_DISABLED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x94A3B8), LV_STATE_DISABLED);
...
static bool fg_system_storage_create_name_dialog(void)
{
    ...
    lv_obj_set_width(error, 450); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 110); lv_obj_set_style_text_color(error, lv_color_hex(0x06B6D4), 0);
...
static bool fg_system_storage_create_format_dialog(void)
{
    ...
    lv_label_set_text(title, "FORMAT SD CARD"); lv_obj_align(title, LV_ALIGN_TOP_MID, 0, 8); fg_system_storage_format_error = error; lv_obj_set_width(error, 520); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 44); lv_obj_set_style_text_color(error, lv_color_hex(0x06B6D4), 0);
...
static bool fg_system_storage_create_delete_folder_dialog(void)
{
    ...
    fg_system_storage_delete_folder_error = error; lv_obj_set_width(error, 500); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 190); lv_obj_set_style_text_color(error, lv_color_hex(0x06B6D4), 0);
...
static bool fg_system_storage_create_page(void)
{
    ...
    lv_obj_set_style_bg_color(fg_system_storage_page, lv_color_hex(0xF7FBFD), 0);
    ...
    lv_label_set_text(title, "SD Card"); lv_obj_set_style_text_color(title, lv_color_hex(0x0F172A), 0); lv_obj_set_style_text_font(title, &lv_font_montserrat_32, 0); lv_obj_align(title, LV_ALIGN_TOP_MID, 0, 24);
    fg_system_storage_summary = lv_label_create(fg_system_storage_page);
    if (!fg_system_storage_summary) goto unavailable;
    lv_obj_set_pos(fg_system_storage_summary, 28, 96); lv_obj_set_width(fg_system_storage_summary, 350); lv_obj_set_style_text_color(fg_system_storage_summary, lv_color_hex(0x0F172A), 0);
    ...
    lv_label_set_text(fg_system_storage_path, "/sdcard"); lv_obj_set_pos(fg_system_storage_path, 565, 92); lv_obj_set_style_text_color(fg_system_storage_path, lv_color_hex(0x06B6D4), 0);
    ...
    for (int i = 0; i < FG_STORAGE_VISIBLE_ROWS; ++i) {
        ...
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0xE6F1F7), LV_STATE_DEFAULT); lv_obj_set_style_border_color(fg_system_storage_rows[i], lv_color_hex(0x94A3B8), LV_STATE_DEFAULT);
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0x06B6D4), LV_STATE_CHECKED); lv_obj_set_style_text_color(fg_system_storage_rows[i], lv_color_hex(0xF7FBFD), LV_STATE_CHECKED);
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0x06B6D4), LV_STATE_PRESSED); lv_obj_set_style_border_color(fg_system_storage_rows[i], lv_color_hex(0x06B6D4), LV_STATE_FOCUSED); lv_obj_set_style_opa(fg_system_storage_rows[i], LV_OPA_40, LV_STATE_DISABLED);
...
static void fg_system_create_disabled_card(lv_obj_t * parent, const char * text, int32_t x, int32_t y)
{
    ...
    lv_obj_set_style_border_color(card, lv_color_hex(0x94A3B8), 0);
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    // Background flavour: Nordic Frost
    lv_obj_set_style_bg_color(lv_screen_active(), lv_color_hex(0xF7FBFD), 0);
    lv_obj_set_style_bg_opa(lv_screen_active(), LV_OPA_COVER, 0);
    lv_obj_set_style_bg_color(parent, lv_color_hex(0xF7FBFD), 0);
    ...
    lv_obj_set_style_bg_color(fg_application_page, lv_color_hex(0xF7FBFD), 0);
    lv_obj_set_style_bg_opa(fg_application_page, LV_OPA_COVER, 0);

    static const char * obj1_map[] = {"One", "Two", "Three", "\n", "Four", "Five", "Six", ""};
    fg_menu_matrix_button_matrix = lv_buttonmatrix_create(fg_application_page);
    lv_obj_t * obj1 = fg_menu_matrix_button_matrix;
    lv_buttonmatrix_set_map(obj1, obj1_map);
    lv_obj_set_pos(obj1, 120, 186);
    ...
    lv_obj_set_style_border_color(obj1, lv_color_hex(0x94A3B8), LV_PART_MAIN);
    lv_obj_set_style_border_width(obj1, 2, LV_PART_MAIN);
    lv_obj_set_style_radius(obj1, 8, LV_PART_MAIN);
    lv_obj_set_style_bg_color(obj1, lv_color_hex(0xE6F1F7), LV_PART_ITEMS);
    lv_obj_set_style_text_color(obj1, lv_color_hex(0x0F172A), LV_PART_ITEMS);
    lv_obj_set_style_border_color(obj1, lv_color_hex(0x94A3B8), LV_PART_ITEMS);
    lv_obj_set_style_border_width(obj1, 1, LV_PART_ITEMS);
    lv_obj_set_style_bg_color(obj1, lv_color_hex(0x94A3B8), LV_PART_ITEMS | LV_STATE_CHECKED);
    lv_obj_set_style_text_color(obj1, lv_color_hex(0xF7FBFD), LV_PART_ITEMS | LV_STATE_CHECKED);
    lv_buttonmatrix_set_selected_button(obj1, 1);
    fg_menu_matrix_button_matrix_selected_index = 1;
    ...
    lv_obj_set_style_bg_color(fg_system_launcher_page, lv_color_hex(0xF7FBFD), 0);
    ...
    lv_obj_set_style_text_color(system_title, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(storage_title, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_storage_summary, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_storage_path, lv_color_hex(0x06B6D4), 0);
    fg_system_storage_parent_button = fg_system_create_button(fg_system_storage_page, LV_SYMBOL_UP " Parent", 410, 78, 135, 48);
    ...
    lv_obj_set_style_bg_color(fg_system_storage_list, lv_color_hex(0xFFFFFF), 0); lv_obj_set_style_border_color(fg_system_storage_list, lv_color_hex(0x94A3B8), 0);
    ...
    if (!storage_row_styles_ready) {
        lv_style_init(&storage_row_default_style); lv_style_set_bg_color(&storage_row_default_style, lv_color_hex(0xE6F1F7)); lv_style_set_border_color(&storage_row_default_style, lv_color_hex(0x94A3B8)); lv_style_set_text_color(&storage_row_default_style, lv_color_hex(0x0F172A));
        lv_style_init(&storage_row_active_style); lv_style_set_bg_color(&storage_row_active_style, lv_color_hex(0x06B6D4)); lv_style_set_text_color(&storage_row_active_style, lv_color_hex(0xF7FBFD));
        lv_style_init(&storage_row_disabled_style); lv_style_set_bg_color(&storage_row_disabled_style, lv_color_hex(0xE6F1F7)); lv_style_set_text_color(&storage_row_disabled_style, lv_color_hex(0x0F172A)); lv_style_set_opa(&storage_row_disabled_style, LV_OPA_40);
    ...
    lv_obj_set_style_text_color(fg_system_storage_empty, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_bg_color(fg_system_wifi_page, lv_color_hex(0xF7FBFD), 0);
    ...
    lv_obj_set_style_text_color(wifi_title, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_bg_color(wifi_status_panel, lv_color_hex(0xFFFFFF), 0);
    lv_obj_set_style_border_color(wifi_status_panel, lv_color_hex(0x94A3B8), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_state_label, lv_color_hex(0x06B6D4), 0);
    ...
    lv_obj_set_style_text_color(wifi_ssid_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_ssid_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(wifi_ip_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_ip_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(wifi_gateway_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_gateway_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(wifi_signal_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_rssi_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(wifi_security_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_security_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(wifi_status_caption, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_raw_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_bg_color(fg_system_wifi_details_card, lv_color_hex(0xFFFFFF), 0);
    lv_obj_set_style_border_color(fg_system_wifi_details_card, lv_color_hex(0x94A3B8), 0);
    ...
    lv_obj_set_style_text_color(wifi_details_title, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_details_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_bg_color(fg_system_wifi_network_container, lv_color_hex(0xFFFFFF), 0);
    lv_obj_set_style_border_color(fg_system_wifi_network_container, lv_color_hex(0x94A3B8), 0);
    ...
    lv_obj_set_style_text_color(fg_system_wifi_network_empty_label, lv_color_hex(0x0F172A), 0);
    ...
    for (int i = 0; i < FG_WIFI_MAX_SCAN; ++i) {
        ...
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0xE6F1F7), 0);
        lv_obj_set_style_bg_opa(fg_system_wifi_network_rows[i], LV_OPA_COVER, 0);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x94A3B8), 0);
        lv_obj_set_style_border_width(fg_system_wifi_network_rows[i], 1, 0);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0x0F172A), 0);
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_PRESSED);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_PRESSED);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0xF7FBFD), LV_STATE_PRESSED);
        lv_obj_set_style_opa(fg_system_wifi_network_rows[i], LV_OPA_80, LV_STATE_PRESSED);
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0xFFFFFF), LV_STATE_FOCUSED);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_FOCUSED);
        lv_obj_set_style_border_width(fg_system_wifi_network_rows[i], 2, LV_STATE_FOCUSED);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0x0F172A), LV_STATE_FOCUSED);
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0xFFFFFF), LV_STATE_FOCUS_KEY);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_FOCUS_KEY);
        lv_obj_set_style_border_width(fg_system_wifi_network_rows[i], 2, LV_STATE_FOCUS_KEY);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0x0F172A), LV_STATE_FOCUS_KEY);
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_CHECKED);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x06B6D4), LV_STATE_CHECKED);
        lv_obj_set_style_border_width(fg_system_wifi_network_rows[i], 3, LV_STATE_CHECKED);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0xF7FBFD), LV_STATE_CHECKED);
        lv_obj_set_style_bg_color(fg_system_wifi_network_rows[i], lv_color_hex(0xE6F1F7), LV_STATE_DISABLED);
        lv_obj_set_style_border_color(fg_system_wifi_network_rows[i], lv_color_hex(0x94A3B8), LV_STATE_DISABLED);
        lv_obj_set_style_text_color(fg_system_wifi_network_rows[i], lv_color_hex(0x0F172A), LV_STATE_DISABLED);
    ...
    lv_obj_set_style_bg_color(fg_system_brightness_page, lv_color_hex(0xF7FBFD), 0);
    ...
    lv_obj_set_style_text_color(brightness_title, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(brightness_icon, lv_color_hex(0x06B6D4), 0);
    ...
    lv_label_set_text_fmt(fg_system_brightness_label, "%u%%", (unsigned)fg_system_brightness_percent);
    lv_obj_set_style_text_color(fg_system_brightness_label, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_bg_color(brightness_slider, lv_color_hex(0xE6F1F7), LV_PART_MAIN);
    lv_obj_set_style_bg_color(brightness_slider, lv_color_hex(0x06B6D4), LV_PART_INDICATOR);
    lv_obj_set_style_bg_color(brightness_slider, lv_color_hex(0x0F172A), LV_PART_KNOB);
    ...
    lv_obj_set_style_text_color(brightness_min, lv_color_hex(0x0F172A), 0);
    ...
    lv_obj_set_style_text_color(brightness_max, lv_color_hex(0x0F172A), 0);
