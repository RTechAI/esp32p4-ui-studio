...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    LV_IMAGE_DECLARE(fg_upload_fiairplay_26ccd278);
    lv_obj_t * obj1 = lv_image_create(parent);
    lv_image_set_src(obj1, &fg_upload_fiairplay_26ccd278);
    lv_image_set_scale(obj1, 256);
    lv_obj_set_pos(obj1, 6, 87);
    lv_obj_set_size(obj1, 577, 250);
    lv_obj_add_flag(obj1, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_set_style_transform_pivot_x(obj1, 288, 0);
    lv_obj_set_style_transform_pivot_y(obj1, 125, 0);
    ...
    lv_label_set_text(obj2, LV_SYMBOL_SETTINGS);
    lv_obj_set_pos(obj2, 21, 355);
    lv_obj_set_style_text_color(obj2, lv_color_hex(0xFFFFFF), 0);
    lv_obj_set_style_text_font(obj2, &lv_font_montserrat_48, 0);

    LV_IMAGE_DECLARE(fg_upload_fialigncenter_befae985);
    lv_obj_t * obj3 = lv_image_create(parent);
    lv_image_set_src(obj3, &fg_upload_fialigncenter_befae985);
    lv_image_set_scale(obj3, 256);
    lv_obj_set_pos(obj3, 702, 57);
    lv_obj_set_size(obj3, 240, 120);
    lv_obj_add_flag(obj3, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_set_style_transform_pivot_x(obj3, 120, 0);
    lv_obj_set_style_transform_pivot_y(obj3, 60, 0);
    lv_obj_set_style_transform_scale(obj3, 256, 0);
    lv_obj_set_style_transform_scale(obj3, 235, LV_STATE_PRESSED);
