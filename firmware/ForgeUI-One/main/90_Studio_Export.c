...
static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_state_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_value_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_unit_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_secondary_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_trend_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_target_label=NULL; static lv_obj_t * fg_comp_msi577_usu8_fm9_kpi_accent=NULL;
static int32_t fg_comp_msi577_usu8_fm9_kpi_status=1; static int32_t fg_comp_msi577_usu8_fm9_kpi_trend_state=1; static char fg_comp_msi577_usu8_fm9_kpi_value[49]="87.4"; static char fg_comp_msi577_usu8_fm9_kpi_unit[25]="%"; static char fg_comp_msi577_usu8_fm9_kpi_secondary[65]="Target 90%"; static char fg_comp_msi577_usu8_fm9_kpi_trend_text[49]="+2.1%"; static char fg_comp_msi577_usu8_fm9_kpi_target[65]="";
static void fg_comp_msi577_usu8_fm9_kpi_refresh(void) { static const char * states[]={"NEUTRAL","GOOD","WARNING","CRITICAL"}; static const char * trends[]={"FLAT","UP","DOWN"}; static const uint32_t colours[]={0x94A3B8,0x22C55E,0xF2A900,0xE5484D}; uint32_t colour=colours[fg_comp_msi577_usu8_fm9_kpi_status]; if(fg_comp_msi577_usu8_fm9_kpi_state_label) { lv_label_set_text(fg_comp_msi577_usu8_fm9_kpi_state_label,states[fg_comp_msi577_usu8_fm9_kpi_status]); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_state_label,lv_color_hex(colour),0); } if(fg_comp_msi577_usu8_fm9_kpi_value_label) { lv_label_set_text(fg_comp_msi577_usu8_fm9_kpi_value_label,fg_comp_msi577_usu8_fm9_kpi_value); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_value_label,lv_color_hex(colour),0); } if(fg_comp_msi577_usu8_fm9_kpi_unit_label) lv_label_set_text(fg_comp_msi577_usu8_fm9_kpi_unit_label,fg_comp_msi577_usu8_fm9_kpi_unit); if(fg_comp_msi577_usu8_fm9_kpi_secondary_label) lv_label_set_text(fg_comp_msi577_usu8_fm9_kpi_secondary_label,fg_comp_msi577_usu8_fm9_kpi_secondary); if(fg_comp_msi577_usu8_fm9_kpi_trend_label) { lv_label_set_text_fmt(fg_comp_msi577_usu8_fm9_kpi_trend_label,"%s  %s",trends[fg_comp_msi577_usu8_fm9_kpi_trend_state],fg_comp_msi577_usu8_fm9_kpi_trend_text); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_trend_label,lv_color_hex(colour),0); } if(fg_comp_msi577_usu8_fm9_kpi_target_label) lv_label_set_text(fg_comp_msi577_usu8_fm9_kpi_target_label,fg_comp_msi577_usu8_fm9_kpi_target); if(fg_comp_msi577_usu8_fm9_kpi_accent) lv_obj_set_style_bg_color(fg_comp_msi577_usu8_fm9_kpi_accent,lv_color_hex(colour),0); }
void FG_Set_Comp_MSI577_USU8_FM9_Value(const char * value) { if(!value) value=""; snprintf(fg_comp_msi577_usu8_fm9_kpi_value,sizeof(fg_comp_msi577_usu8_fm9_kpi_value),"%s",value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Unit(const char * value) { if(!value) value=""; snprintf(fg_comp_msi577_usu8_fm9_kpi_unit,sizeof(fg_comp_msi577_usu8_fm9_kpi_unit),"%s",value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Secondary_Text(const char * value) { if(!value) value=""; snprintf(fg_comp_msi577_usu8_fm9_kpi_secondary,sizeof(fg_comp_msi577_usu8_fm9_kpi_secondary),"%s",value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Trend_Text(const char * value) { if(!value) value=""; snprintf(fg_comp_msi577_usu8_fm9_kpi_trend_text,sizeof(fg_comp_msi577_usu8_fm9_kpi_trend_text),"%s",value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Trend_State(int32_t value) { fg_comp_msi577_usu8_fm9_kpi_trend_state=value<0?0:(value>2?2:value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Status(int32_t value) { fg_comp_msi577_usu8_fm9_kpi_status=value<0?0:(value>3?3:value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
void FG_Set_Comp_MSI577_USU8_FM9_Target_Text(const char * value) { if(!value) value=""; snprintf(fg_comp_msi577_usu8_fm9_kpi_target,sizeof(fg_comp_msi577_usu8_fm9_kpi_target),"%s",value); fg_comp_msi577_usu8_fm9_kpi_refresh(); }
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    fg_comp_msi577_usu8_fm9_kpi=lv_obj_create(fg_application_page); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi,595,105.70000076293945); lv_obj_set_size(fg_comp_msi577_usu8_fm9_kpi,240,145); lv_obj_clear_flag(fg_comp_msi577_usu8_fm9_kpi,LV_OBJ_FLAG_SCROLLABLE); lv_obj_set_style_pad_all(fg_comp_msi577_usu8_fm9_kpi,0,0); lv_obj_set_style_radius(fg_comp_msi577_usu8_fm9_kpi,8,0); lv_obj_set_style_bg_color(fg_comp_msi577_usu8_fm9_kpi,lv_color_hex(0x1E2328),0); lv_obj_set_style_border_color(fg_comp_msi577_usu8_fm9_kpi,lv_color_hex(0xF2A900),0); lv_obj_set_style_border_width(fg_comp_msi577_usu8_fm9_kpi,1,0);
    lv_obj_t * obj1_title=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_label_set_text(obj1_title,"Efficiency"); lv_obj_set_pos(obj1_title,10,10); lv_obj_set_width(obj1_title,124); lv_label_set_long_mode(obj1_title,LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(obj1_title,&lv_font_montserrat_12,0); lv_obj_set_style_text_color(obj1_title,lv_color_hex(0xF5F5F5),0);
    fg_comp_msi577_usu8_fm9_kpi_state_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_state_label,140,11); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_state_label,90); lv_obj_set_style_text_align(fg_comp_msi577_usu8_fm9_kpi_state_label,LV_TEXT_ALIGN_RIGHT,0); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_state_label,&lv_font_montserrat_10,0); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_state_label,lv_color_hex(0x22C55E),0);
    fg_comp_msi577_usu8_fm9_kpi_value_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_value_label,10,31); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_value_label,164); lv_label_set_long_mode(fg_comp_msi577_usu8_fm9_kpi_value_label,LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_value_label,&lv_font_montserrat_24,0); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_value_label,lv_color_hex(0x22C55E),0);
    fg_comp_msi577_usu8_fm9_kpi_unit_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_unit_label,176,42); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_unit_label,54); lv_label_set_long_mode(fg_comp_msi577_usu8_fm9_kpi_unit_label,LV_LABEL_LONG_DOT); lv_obj_set_style_text_align(fg_comp_msi577_usu8_fm9_kpi_unit_label,LV_TEXT_ALIGN_RIGHT,0); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_unit_label,&lv_font_montserrat_12,0); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_unit_label,lv_color_hex(0xB5B6B8),0);
    fg_comp_msi577_usu8_fm9_kpi_secondary_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_secondary_label,10,66); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_secondary_label,220); lv_label_set_long_mode(fg_comp_msi577_usu8_fm9_kpi_secondary_label,LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_secondary_label,&lv_font_montserrat_10,0); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_secondary_label,lv_color_hex(0xB5B6B8),0);
    fg_comp_msi577_usu8_fm9_kpi_trend_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_trend_label,10,110); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_trend_label,110); lv_label_set_long_mode(fg_comp_msi577_usu8_fm9_kpi_trend_label,LV_LABEL_LONG_DOT); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_trend_label,&lv_font_montserrat_10,0);
    fg_comp_msi577_usu8_fm9_kpi_target_label=lv_label_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_target_label,120,110); lv_obj_set_width(fg_comp_msi577_usu8_fm9_kpi_target_label,110); lv_label_set_long_mode(fg_comp_msi577_usu8_fm9_kpi_target_label,LV_LABEL_LONG_DOT); lv_obj_set_style_text_align(fg_comp_msi577_usu8_fm9_kpi_target_label,LV_TEXT_ALIGN_RIGHT,0); lv_obj_set_style_text_font(fg_comp_msi577_usu8_fm9_kpi_target_label,&lv_font_montserrat_10,0); lv_obj_set_style_text_color(fg_comp_msi577_usu8_fm9_kpi_target_label,lv_color_hex(0xB5B6B8),0); lv_obj_add_flag(fg_comp_msi577_usu8_fm9_kpi_target_label,LV_OBJ_FLAG_HIDDEN);
    fg_comp_msi577_usu8_fm9_kpi_accent=lv_obj_create(fg_comp_msi577_usu8_fm9_kpi); lv_obj_set_pos(fg_comp_msi577_usu8_fm9_kpi_accent,10,137); lv_obj_set_size(fg_comp_msi577_usu8_fm9_kpi_accent,220,4); lv_obj_set_style_border_width(fg_comp_msi577_usu8_fm9_kpi_accent,0,0); lv_obj_set_style_radius(fg_comp_msi577_usu8_fm9_kpi_accent,2,0); lv_obj_clear_flag(fg_comp_msi577_usu8_fm9_kpi_accent,LV_OBJ_FLAG_SCROLLABLE);
    fg_comp_msi577_usu8_fm9_kpi_refresh();
