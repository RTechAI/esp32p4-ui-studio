...
static lv_obj_t * fg_comp_msh8868_tntwc1_io_monitor = NULL;
static lv_obj_t * fg_comp_msh8868_tntwc1_io_rows[4] = {0}; static lv_obj_t * fg_comp_msh8868_tntwc1_io_channel_labels[4] = {0}; static lv_obj_t * fg_comp_msh8868_tntwc1_io_name_labels[4] = {0};
static lv_obj_t * fg_comp_msh8868_tntwc1_io_value_labels[4] = {0}; static lv_obj_t * fg_comp_msh8868_tntwc1_io_state_labels[4] = {0};
static const char * fg_comp_msh8868_tntwc1_io_channels[4] = {"DI1", "DO1", "AI1", "AO1"};
static FG_IO_Type fg_comp_msh8868_tntwc1_io_types[4] = {FG_IO_DIGITAL_INPUT, FG_IO_DIGITAL_OUTPUT, FG_IO_ANALOG_INPUT, FG_IO_ANALOG_OUTPUT};
static float fg_comp_msh8868_tntwc1_io_values[4] = {0.0f, 1.0f, 4.62f, 68.0f};
static bool fg_comp_msh8868_tntwc1_io_states[4] = {false, true, true, true};
static void fg_comp_msh8868_tntwc1_io_refresh(void)
{
    if (fg_comp_msh8868_tntwc1_io_channel_labels[0]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_channel_labels[0], fg_comp_msh8868_tntwc1_io_channels[0]);
    if (fg_comp_msh8868_tntwc1_io_name_labels[0]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_name_labels[0], "Emergency Stop");
    if (fg_comp_msh8868_tntwc1_io_value_labels[0]) lv_obj_add_flag(fg_comp_msh8868_tntwc1_io_value_labels[0], LV_OBJ_FLAG_HIDDEN);
    if (fg_comp_msh8868_tntwc1_io_state_labels[0]) { lv_label_set_text(fg_comp_msh8868_tntwc1_io_state_labels[0], fg_comp_msh8868_tntwc1_io_states[0] ? "ON" : "OFF"); lv_obj_set_style_text_color(fg_comp_msh8868_tntwc1_io_state_labels[0], lv_color_hex(fg_comp_msh8868_tntwc1_io_states[0] ? 0x22C55E : 0xB5B6B8), 0); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_state_labels[0], LV_OBJ_FLAG_HIDDEN); }
    if (fg_comp_msh8868_tntwc1_io_channel_labels[1]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_channel_labels[1], fg_comp_msh8868_tntwc1_io_channels[1]);
    if (fg_comp_msh8868_tntwc1_io_name_labels[1]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_name_labels[1], "Pump");
    if (fg_comp_msh8868_tntwc1_io_value_labels[1]) lv_obj_add_flag(fg_comp_msh8868_tntwc1_io_value_labels[1], LV_OBJ_FLAG_HIDDEN);
    if (fg_comp_msh8868_tntwc1_io_state_labels[1]) { lv_label_set_text(fg_comp_msh8868_tntwc1_io_state_labels[1], fg_comp_msh8868_tntwc1_io_states[1] ? "ON" : "OFF"); lv_obj_set_style_text_color(fg_comp_msh8868_tntwc1_io_state_labels[1], lv_color_hex(fg_comp_msh8868_tntwc1_io_states[1] ? 0x38BDF8 : 0xB5B6B8), 0); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_state_labels[1], LV_OBJ_FLAG_HIDDEN); }
    if (fg_comp_msh8868_tntwc1_io_channel_labels[2]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_channel_labels[2], fg_comp_msh8868_tntwc1_io_channels[2]);
    if (fg_comp_msh8868_tntwc1_io_name_labels[2]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_name_labels[2], "Pressure");
    if (fg_comp_msh8868_tntwc1_io_value_labels[2]) { lv_label_set_text_fmt(fg_comp_msh8868_tntwc1_io_value_labels[2], "%.3g%s%s", (double)fg_comp_msh8868_tntwc1_io_values[2], " ", "bar"); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_value_labels[2], LV_OBJ_FLAG_HIDDEN); }
    if (fg_comp_msh8868_tntwc1_io_state_labels[2]) { lv_label_set_text(fg_comp_msh8868_tntwc1_io_state_labels[2], fg_comp_msh8868_tntwc1_io_states[2] ? "ON" : "OFF"); lv_obj_set_style_text_color(fg_comp_msh8868_tntwc1_io_state_labels[2], lv_color_hex(fg_comp_msh8868_tntwc1_io_states[2] ? 0xF2A900 : 0xB5B6B8), 0); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_state_labels[2], LV_OBJ_FLAG_HIDDEN); }
    if (fg_comp_msh8868_tntwc1_io_channel_labels[3]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_channel_labels[3], fg_comp_msh8868_tntwc1_io_channels[3]);
    if (fg_comp_msh8868_tntwc1_io_name_labels[3]) lv_label_set_text(fg_comp_msh8868_tntwc1_io_name_labels[3], "Valve Demand");
    if (fg_comp_msh8868_tntwc1_io_value_labels[3]) { lv_label_set_text_fmt(fg_comp_msh8868_tntwc1_io_value_labels[3], "%.3g%s%s", (double)fg_comp_msh8868_tntwc1_io_values[3], " ", "%%"); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_value_labels[3], LV_OBJ_FLAG_HIDDEN); }
    if (fg_comp_msh8868_tntwc1_io_state_labels[3]) { lv_label_set_text(fg_comp_msh8868_tntwc1_io_state_labels[3], fg_comp_msh8868_tntwc1_io_states[3] ? "ON" : "OFF"); lv_obj_set_style_text_color(fg_comp_msh8868_tntwc1_io_state_labels[3], lv_color_hex(fg_comp_msh8868_tntwc1_io_states[3] ? 0xA78BFA : 0xB5B6B8), 0); lv_obj_remove_flag(fg_comp_msh8868_tntwc1_io_state_labels[3], LV_OBJ_FLAG_HIDDEN); }
}

static void fg_comp_msh8868_tntwc1_io_selected_cb(lv_event_t * event) { uint32_t row = (uint32_t)(uintptr_t)lv_event_get_user_data(event); if (row < 4u) FG_On_Comp_MSH8868_TNTWC1_Row_Selected(fg_comp_msh8868_tntwc1_io_channels[row], fg_comp_msh8868_tntwc1_io_types[row]); }

bool FG_Set_Comp_MSH8868_TNTWC1_DigitalInput(const char * channel, bool state) { if (!channel) return false; for (uint32_t i = 0; i < 4u; ++i) if (fg_comp_msh8868_tntwc1_io_types[i] == FG_IO_DIGITAL_INPUT && strcmp(fg_comp_msh8868_tntwc1_io_channels[i], channel) == 0) { fg_comp_msh8868_tntwc1_io_states[i] = state; fg_comp_msh8868_tntwc1_io_values[i] = state ? 1.0f : 0.0f; fg_comp_msh8868_tntwc1_io_refresh(); return true; } return false; }
bool FG_Set_Comp_MSH8868_TNTWC1_DigitalOutput(const char * channel, bool state) { if (!channel) return false; for (uint32_t i = 0; i < 4u; ++i) if (fg_comp_msh8868_tntwc1_io_types[i] == FG_IO_DIGITAL_OUTPUT && strcmp(fg_comp_msh8868_tntwc1_io_channels[i], channel) == 0) { fg_comp_msh8868_tntwc1_io_states[i] = state; fg_comp_msh8868_tntwc1_io_values[i] = state ? 1.0f : 0.0f; fg_comp_msh8868_tntwc1_io_refresh(); return true; } return false; }
bool FG_Set_Comp_MSH8868_TNTWC1_AnalogInput(const char * channel, float value) { if (!channel) return false; for (uint32_t i = 0; i < 4u; ++i) if (fg_comp_msh8868_tntwc1_io_types[i] == FG_IO_ANALOG_INPUT && strcmp(fg_comp_msh8868_tntwc1_io_channels[i], channel) == 0) { fg_comp_msh8868_tntwc1_io_values[i] = value; fg_comp_msh8868_tntwc1_io_refresh(); return true; } return false; }
bool FG_Set_Comp_MSH8868_TNTWC1_AnalogOutput(const char * channel, float value) { if (!channel) return false; for (uint32_t i = 0; i < 4u; ++i) if (fg_comp_msh8868_tntwc1_io_types[i] == FG_IO_ANALOG_OUTPUT && strcmp(fg_comp_msh8868_tntwc1_io_channels[i], channel) == 0) { fg_comp_msh8868_tntwc1_io_values[i] = value; fg_comp_msh8868_tntwc1_io_refresh(); return true; } return false; }
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    fg_comp_msh8868_tntwc1_io_monitor = lv_obj_create(fg_application_page);
    lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_monitor, 544.9999847412109, 53); lv_obj_set_size(fg_comp_msh8868_tntwc1_io_monitor, 420, 207);
    lv_obj_set_style_bg_color(fg_comp_msh8868_tntwc1_io_monitor, lv_color_hex(0x1E2328), 0); lv_obj_set_style_border_color(fg_comp_msh8868_tntwc1_io_monitor, lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_comp_msh8868_tntwc1_io_monitor, 1, 0); lv_obj_set_style_radius(fg_comp_msh8868_tntwc1_io_monitor, 10, 0); lv_obj_set_style_pad_all(fg_comp_msh8868_tntwc1_io_monitor, 0, 0); lv_obj_clear_flag(fg_comp_msh8868_tntwc1_io_monitor, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_t * obj1_title = lv_label_create(fg_comp_msh8868_tntwc1_io_monitor); lv_label_set_text(obj1_title, "IO Monitor"); lv_obj_set_pos(obj1_title, 12, 11); lv_obj_set_style_text_color(obj1_title, lv_color_hex(0xF5F5F5), 0);
    fg_comp_msh8868_tntwc1_io_rows[0] = lv_button_create(fg_comp_msh8868_tntwc1_io_monitor); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_rows[0], 8, 42); lv_obj_set_size(fg_comp_msh8868_tntwc1_io_rows[0], 404, 38);
    lv_obj_set_style_bg_color(fg_comp_msh8868_tntwc1_io_rows[0], lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_comp_msh8868_tntwc1_io_rows[0], lv_color_hex(0x22C55E), 0); lv_obj_set_style_border_width(fg_comp_msh8868_tntwc1_io_rows[0], 3, 0); lv_obj_set_style_border_side(fg_comp_msh8868_tntwc1_io_rows[0], LV_BORDER_SIDE_LEFT, 0); lv_obj_set_style_radius(fg_comp_msh8868_tntwc1_io_rows[0], 5, 0); lv_obj_set_style_pad_all(fg_comp_msh8868_tntwc1_io_rows[0], 0, 0);
    fg_comp_msh8868_tntwc1_io_channel_labels[0] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[0]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_channel_labels[0], 8, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_channel_labels[0], 48); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_channel_labels[0], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_name_labels[0] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[0]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_name_labels[0], 62, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_name_labels[0], 204); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_name_labels[0], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_value_labels[0] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[0]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_value_labels[0], 276, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_value_labels[0], 76); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_value_labels[0], LV_TEXT_ALIGN_RIGHT, 0);
    fg_comp_msh8868_tntwc1_io_state_labels[0] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[0]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_state_labels[0], 360, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_state_labels[0], 36); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_state_labels[0], LV_TEXT_ALIGN_RIGHT, 0);
    lv_obj_add_event_cb(fg_comp_msh8868_tntwc1_io_rows[0], fg_comp_msh8868_tntwc1_io_selected_cb, LV_EVENT_CLICKED, (void *)(uintptr_t)0);
    fg_comp_msh8868_tntwc1_io_rows[1] = lv_button_create(fg_comp_msh8868_tntwc1_io_monitor); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_rows[1], 8, 85); lv_obj_set_size(fg_comp_msh8868_tntwc1_io_rows[1], 404, 38);
    lv_obj_set_style_bg_color(fg_comp_msh8868_tntwc1_io_rows[1], lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_comp_msh8868_tntwc1_io_rows[1], lv_color_hex(0x38BDF8), 0); lv_obj_set_style_border_width(fg_comp_msh8868_tntwc1_io_rows[1], 3, 0); lv_obj_set_style_border_side(fg_comp_msh8868_tntwc1_io_rows[1], LV_BORDER_SIDE_LEFT, 0); lv_obj_set_style_radius(fg_comp_msh8868_tntwc1_io_rows[1], 5, 0); lv_obj_set_style_pad_all(fg_comp_msh8868_tntwc1_io_rows[1], 0, 0);
    fg_comp_msh8868_tntwc1_io_channel_labels[1] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[1]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_channel_labels[1], 8, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_channel_labels[1], 48); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_channel_labels[1], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_name_labels[1] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[1]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_name_labels[1], 62, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_name_labels[1], 204); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_name_labels[1], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_value_labels[1] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[1]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_value_labels[1], 276, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_value_labels[1], 76); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_value_labels[1], LV_TEXT_ALIGN_RIGHT, 0);
    fg_comp_msh8868_tntwc1_io_state_labels[1] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[1]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_state_labels[1], 360, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_state_labels[1], 36); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_state_labels[1], LV_TEXT_ALIGN_RIGHT, 0);
    lv_obj_add_event_cb(fg_comp_msh8868_tntwc1_io_rows[1], fg_comp_msh8868_tntwc1_io_selected_cb, LV_EVENT_CLICKED, (void *)(uintptr_t)1);
    fg_comp_msh8868_tntwc1_io_rows[2] = lv_button_create(fg_comp_msh8868_tntwc1_io_monitor); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_rows[2], 8, 128); lv_obj_set_size(fg_comp_msh8868_tntwc1_io_rows[2], 404, 38);
    lv_obj_set_style_bg_color(fg_comp_msh8868_tntwc1_io_rows[2], lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_comp_msh8868_tntwc1_io_rows[2], lv_color_hex(0xF2A900), 0); lv_obj_set_style_border_width(fg_comp_msh8868_tntwc1_io_rows[2], 3, 0); lv_obj_set_style_border_side(fg_comp_msh8868_tntwc1_io_rows[2], LV_BORDER_SIDE_LEFT, 0); lv_obj_set_style_radius(fg_comp_msh8868_tntwc1_io_rows[2], 5, 0); lv_obj_set_style_pad_all(fg_comp_msh8868_tntwc1_io_rows[2], 0, 0);
    fg_comp_msh8868_tntwc1_io_channel_labels[2] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[2]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_channel_labels[2], 8, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_channel_labels[2], 48); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_channel_labels[2], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_name_labels[2] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[2]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_name_labels[2], 62, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_name_labels[2], 204); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_name_labels[2], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_value_labels[2] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[2]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_value_labels[2], 276, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_value_labels[2], 76); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_value_labels[2], LV_TEXT_ALIGN_RIGHT, 0);
    fg_comp_msh8868_tntwc1_io_state_labels[2] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[2]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_state_labels[2], 360, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_state_labels[2], 36); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_state_labels[2], LV_TEXT_ALIGN_RIGHT, 0);
    lv_obj_add_event_cb(fg_comp_msh8868_tntwc1_io_rows[2], fg_comp_msh8868_tntwc1_io_selected_cb, LV_EVENT_CLICKED, (void *)(uintptr_t)2);
    fg_comp_msh8868_tntwc1_io_rows[3] = lv_button_create(fg_comp_msh8868_tntwc1_io_monitor); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_rows[3], 8, 171); lv_obj_set_size(fg_comp_msh8868_tntwc1_io_rows[3], 404, 38);
    lv_obj_set_style_bg_color(fg_comp_msh8868_tntwc1_io_rows[3], lv_color_hex(0x2A3138), 0); lv_obj_set_style_border_color(fg_comp_msh8868_tntwc1_io_rows[3], lv_color_hex(0xA78BFA), 0); lv_obj_set_style_border_width(fg_comp_msh8868_tntwc1_io_rows[3], 3, 0); lv_obj_set_style_border_side(fg_comp_msh8868_tntwc1_io_rows[3], LV_BORDER_SIDE_LEFT, 0); lv_obj_set_style_radius(fg_comp_msh8868_tntwc1_io_rows[3], 5, 0); lv_obj_set_style_pad_all(fg_comp_msh8868_tntwc1_io_rows[3], 0, 0);
    fg_comp_msh8868_tntwc1_io_channel_labels[3] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[3]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_channel_labels[3], 8, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_channel_labels[3], 48); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_channel_labels[3], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_name_labels[3] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[3]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_name_labels[3], 62, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_name_labels[3], 204); lv_label_set_long_mode(fg_comp_msh8868_tntwc1_io_name_labels[3], LV_LABEL_LONG_DOT);
    fg_comp_msh8868_tntwc1_io_value_labels[3] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[3]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_value_labels[3], 276, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_value_labels[3], 76); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_value_labels[3], LV_TEXT_ALIGN_RIGHT, 0);
    fg_comp_msh8868_tntwc1_io_state_labels[3] = lv_label_create(fg_comp_msh8868_tntwc1_io_rows[3]); lv_obj_set_pos(fg_comp_msh8868_tntwc1_io_state_labels[3], 360, 12); lv_obj_set_width(fg_comp_msh8868_tntwc1_io_state_labels[3], 36); lv_obj_set_style_text_align(fg_comp_msh8868_tntwc1_io_state_labels[3], LV_TEXT_ALIGN_RIGHT, 0);
    lv_obj_add_event_cb(fg_comp_msh8868_tntwc1_io_rows[3], fg_comp_msh8868_tntwc1_io_selected_cb, LV_EVENT_CLICKED, (void *)(uintptr_t)3);
    fg_comp_msh8868_tntwc1_io_refresh();
