...
static lv_obj_t * fg_system_create_button(lv_obj_t * parent, const char * text, int32_t x, int32_t y, int32_t width, int32_t height)
{
    ...
    lv_obj_set_style_bg_color(button, lv_color_hex(0x0EA5E9), LV_STATE_PRESSED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x0EA5E9), LV_STATE_PRESSED);
    lv_obj_set_style_bg_color(button, lv_color_hex(0xC9D4DC), LV_STATE_FOCUSED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x0EA5E9), LV_STATE_FOCUSED);
    lv_obj_set_style_bg_color(button, lv_color_hex(0xC9D4DC), LV_STATE_DISABLED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x64748B), LV_STATE_DISABLED);
...
static bool fg_system_storage_create_name_dialog(void)
{
    ...
    lv_obj_set_width(error, 450); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 110); lv_obj_set_style_text_color(error, lv_color_hex(0x0EA5E9), 0);
...
static bool fg_system_storage_create_format_dialog(void)
{
    ...
    lv_label_set_text(title, "FORMAT SD CARD"); lv_obj_align(title, LV_ALIGN_TOP_MID, 0, 8); fg_system_storage_format_error = error; lv_obj_set_width(error, 520); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 44); lv_obj_set_style_text_color(error, lv_color_hex(0x0EA5E9), 0);
...
static bool fg_system_storage_create_delete_folder_dialog(void)
{
    ...
    fg_system_storage_delete_folder_error = error; lv_obj_set_width(error, 500); lv_obj_align(error, LV_ALIGN_TOP_MID, 0, 190); lv_obj_set_style_text_color(error, lv_color_hex(0x0EA5E9), 0);
...
static bool fg_system_storage_create_page(void)
{
    ...
    lv_obj_set_style_bg_color(fg_system_storage_page, lv_color_hex(0xDCE3E8), 0);
    ...
    lv_label_set_text(title, "SD Card"); lv_obj_set_style_text_color(title, lv_color_hex(0x1E293B), 0); lv_obj_set_style_text_font(title, &lv_font_montserrat_32, 0); lv_obj_align(title, LV_ALIGN_TOP_MID, 0, 24);
    fg_system_storage_summary = lv_label_create(fg_system_storage_page);
    if (!fg_system_storage_summary) goto unavailable;
    lv_obj_set_pos(fg_system_storage_summary, 28, 96); lv_obj_set_width(fg_system_storage_summary, 350); lv_obj_set_style_text_color(fg_system_storage_summary, lv_color_hex(0x1E293B), 0);
    ...
    lv_label_set_text(fg_system_storage_path, "/sdcard"); lv_obj_set_pos(fg_system_storage_path, 565, 92); lv_obj_set_style_text_color(fg_system_storage_path, lv_color_hex(0x0EA5E9), 0);
    ...
    for (int i = 0; i < FG_STORAGE_VISIBLE_ROWS; ++i) {
        ...
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0xC9D4DC), LV_STATE_DEFAULT); lv_obj_set_style_border_color(fg_system_storage_rows[i], lv_color_hex(0x64748B), LV_STATE_DEFAULT);
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0x0EA5E9), LV_STATE_CHECKED); lv_obj_set_style_text_color(fg_system_storage_rows[i], lv_color_hex(0xDCE3E8), LV_STATE_CHECKED);
        lv_obj_set_style_bg_color(fg_system_storage_rows[i], lv_color_hex(0x0EA5E9), LV_STATE_PRESSED); lv_obj_set_style_border_color(fg_system_storage_rows[i], lv_color_hex(0x0EA5E9), LV_STATE_FOCUSED); lv_obj_set_style_opa(fg_system_storage_rows[i], LV_OPA_40, LV_STATE_DISABLED);
...
void fg_studio_export_create(lv_obj_t *parent)
{
    ...
    lv_image_set_src(bg_texture_0, &fg_upload_ai_hero_1785141178577_0a8ccfd2);
    ...
    lv_obj_set_style_text_color(storage_title, lv_color_hex(0x1E293B), 0);
    ...
    lv_obj_set_style_text_color(fg_system_storage_summary, lv_color_hex(0x1E293B), 0);
    ...
    lv_obj_set_style_text_color(fg_system_storage_path, lv_color_hex(0x0EA5E9), 0);
    fg_system_storage_parent_button = fg_system_create_button(fg_system_storage_page, LV_SYMBOL_UP " Parent", 410, 78, 135, 48);
    ...
    lv_obj_set_style_bg_color(fg_system_storage_list, lv_color_hex(0xF6F8FA), 0); lv_obj_set_style_border_color(fg_system_storage_list, lv_color_hex(0x64748B), 0);
    ...
    if (!storage_row_styles_ready) {
        lv_style_init(&storage_row_default_style); lv_style_set_bg_color(&storage_row_default_style, lv_color_hex(0xC9D4DC)); lv_style_set_border_color(&storage_row_default_style, lv_color_hex(0x64748B)); lv_style_set_text_color(&storage_row_default_style, lv_color_hex(0x1E293B));
        lv_style_init(&storage_row_active_style); lv_style_set_bg_color(&storage_row_active_style, lv_color_hex(0x0EA5E9)); lv_style_set_text_color(&storage_row_active_style, lv_color_hex(0xDCE3E8));
        lv_style_init(&storage_row_disabled_style); lv_style_set_bg_color(&storage_row_disabled_style, lv_color_hex(0xC9D4DC)); lv_style_set_text_color(&storage_row_disabled_style, lv_color_hex(0x1E293B)); lv_style_set_opa(&storage_row_disabled_style, LV_OPA_40);
    ...
    lv_obj_set_style_text_color(fg_system_storage_empty, lv_color_hex(0x1E293B), 0);
