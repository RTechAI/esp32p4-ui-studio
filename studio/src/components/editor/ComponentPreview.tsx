...
} from '~forgeui/preview/StandardClosureWidgetPreviews'
...
import { FORGEUI_INTERACTIVE_ASSETS_UPDATED_EVENT } from '~forgeui/ForgeUINavigation'
...
const ComponentPreview: React.FC<{
  ...
  useEffect(() => {
    ...
    window.addEventListener('forgeui-assets-updated', refreshArtworkDimensions)
  ...
  switch (type) {
        ...
        >
          ...
          >
            <StandardRadioPreview
              ...
              colorScheme={component.props.colorScheme || 'blue'}
    ...
    case 'InteractiveButton':
      return (
        <PreviewContainer
          ...
          resizeAspectRatio={getInteractiveButtonCanvasAspectRatio(component)}
          {...forwardedProps}
        >
    ...
    case 'InteractiveStatusIndicator':
      return (
        <PreviewContainer
          ...
          enableVisualHelper
          resizeMode="selection-border"
          resizeAspectRatio={getInteractiveStatusIndicatorCanvasAspectRatio(
            component,
          )}
          {...forwardedProps}
        >
    ...
    case 'InteractiveToggleSwitch':
      return (
        <PreviewContainer
          ...
          enableVisualHelper
          resizeMode="selection-border"
          resizeAspectRatio={getInteractiveToggleCanvasAspectRatio(component)}
          {...forwardedProps}
        >
    ...
    case 'InteractiveThreePositionToggleSwitch':
      return (
        <PreviewContainer
          ...
          enableVisualHelper
          resizeMode="selection-border"
          resizeAspectRatio={getInteractiveThreePositionCanvasAspectRatio(
            component,
          )}
          {...forwardedProps}
        >
    ...
    case 'Button':
      return (
        <PreviewContainer component={component} {...forwardedProps}>
    ...
    case 'Text':
      return (
        <PreviewContainer
          ...
          {...forwardedProps}
        >
          <StandardTextPreview component={component} palette={previewPalette} />
        </PreviewContainer>
      )
    case 'Link':
      return (
      ...
      return (
        ...
        >
          <Chakra.Box
            ...
            border={`1px solid ${previewTheme.surfaceBorder}`}
            borderRadius="8px"
            bg={`${previewTheme.surface}B3`}
            data-testid="standard-keyboard-canvas"
          >
            {[
    ...
    case 'Span':
      return (
        <PreviewContainer
          ...
          {...forwardedProps}
        >
          <StandardSpanPreview component={component} palette={previewTheme} />
        </PreviewContainer>
      )
    ...
    case 'ImageButton':
      return (
        <PreviewContainer
          ...
          {...forwardedProps}
        >
          <StandardImageButtonPreview component={component} mode="canvas" />
        </PreviewContainer>
      )
