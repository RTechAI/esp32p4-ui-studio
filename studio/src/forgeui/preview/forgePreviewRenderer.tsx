...
import {
  StandardSpanPreview,
  StandardAnimImagePreview,
  StandardImageButtonPreview,
} from './StandardClosureWidgetPreviews'
  ...
  ;(component.children || []).forEach((key: string) => {
    ...
    switch (child.type) {
      ...
      case 'InteractiveButton': {
        output.push(
          <Box
            ...
            top={`${y}px`}
          >
            <InteractiveButtonCanvasPreview component={child} />
          </Box>,
        )
        break
      }
      ...
      case 'Calendar': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardCalendarPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'Scale': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardScalePreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'Msgbox': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardMessageBoxPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'Roller': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardRollerPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'ButtonMatrix': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardButtonMatrixPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'AnimImage': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardAnimImagePreview component={child} palette={theme} />
          </Box>,
        )
        break
      }
      ...
      case 'Span': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardSpanPreview component={child} palette={theme} />
          </Box>,
        )
        break
      }
      ...
      case 'ImageButton': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardImageButtonPreview component={child} mode="browser" />
          </Box>,
        )
        break
      }
      ...
      case 'Window': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardWindowPreview component={child} mode="browser">
              {renderForgePreview({ component: child, components })}
      ...
      case 'Menu': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <StandardMenuPreview component={child} mode="browser" />
          </Box>,
        )
        break
      }
      ...
      case 'SensorTile': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <ForgeUISensorTilePreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'RelayPanel': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <ForgeUIRelayPanelPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'PwmController': {
        output.push(
          <Box key={child.id} {...commonStyle}>
            <ForgeUIPwmControllerPreview component={child} palette={palette} />
          </Box>,
        )
        break
      }
      ...
      case 'PowerFlowCard': { output.push(<Box key={child.id} {...commonStyle}><ForgeUIPowerFlowCardPreview component={child} palette={palette}/></Box>); break }
