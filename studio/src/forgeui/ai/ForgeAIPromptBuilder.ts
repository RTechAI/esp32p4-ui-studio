...
export const forgeAIPromptBuilderGroups: ForgeAIPromptBuilderGroup[] = [
  ...
  { label: 'Charts', types: ['Chart'] },
  {
    ...
    types: ['DashboardCard', 'SensorTile', 'RelayPanel', 'TrendChart', 'TrendChartPro', 'AlarmPanel', 'IOMonitor', 'BatteryCard', 'TankLevelCard', 'NetworkStatusCard', 'DeviceSummaryCard', 'KpiCard', 'PowerFlowCard'],
  },
