...
const categories: Record<ForgeUIWidgetCategory, ComponentType[]> = {
  ...
  Dashboard: [
    ...
    'IOMonitor',
    'BatteryCard',
    'TankLevelCard', 'NetworkStatusCard',
  ],
  Assets: [
    'InteractiveButton',
    'InteractiveLight',
...
export const forgeUIWidgetDefinitions: ForgeUIWidgetDefinition[] = (Object.values(
  ...
  return {
    ...
    origin:
      ...
      type === 'RelayPanel' ||
      type === 'PwmController' ||
      type === 'TrendChart' || type === 'TrendChartPro' || type === 'AlarmPanel' || type === 'IOMonitor' || type === 'BatteryCard' || type === 'TankLevelCard' || type === 'NetworkStatusCard'
        ? 'forgeui-native'
        : 'lvgl-standard',
    ...(type === 'DashboardCard' ||
    type === 'SensorTile' ||
