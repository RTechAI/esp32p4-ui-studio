...
The current Studio names are **01 — GPIO Digital I/O**, **02 — I²C FRAM Persistence**, **03 — SPI NFC/RFID**, and **04 — Online Services — Live Weather**. Every compact sidebar card exposes the same **Load Example** and **Guide** actions. Guides for Examples 01–03 contain wiring and test instructions; Example 04 uses Guide for its online-service, Weather presentation and proof summary.
