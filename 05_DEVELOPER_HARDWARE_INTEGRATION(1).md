...
# 10. Example: UI Button Toggles a Relay
    ...
    bool enabled)
{
    ...
    FG_Set_Main_Relay_Checked(enabled);
    FG_Set_Relay_Status_LED(enabled);
}
```
...
| Interactive Toggle | runtime input family | `FG_On_*_Toggled()` |
| Interactive Three-Position | runtime input family | `FG_On_*_Changed(enum)` |
